<?php
/**
 * Plugin Name: Profile Builder - bbPress Add-on
 * Plugin URI: http://www.cozmoslabs.com/wordpress-profile-builder
 * Description: Integrates Profile Builder with bbPress, allowing you to transfer bbPress user profile to Profile Builder user profile automatically.
 * Version: 1.0.3
...
*/
function wppb_bbp_plugin_init() {
    if( function_exists( 'wppb_return_bytes' ) ) {

        /*
        * Define plugin path
        */
        define('WPPB_BBP_PLUGIN_DIR', WP_PLUGIN_DIR . '/' . dirname(plugin_basename(__FILE__)));


        /*
         * Include the file for creating the bbPress subpage under Profile Builder menu
         */
        if (file_exists(WPPB_BBP_PLUGIN_DIR . '/bbpress-page.php'))
            include_once(WPPB_BBP_PLUGIN_DIR . '/bbpress-page.php');
        ...
        *
        */
        if ( defined(WPPB_PLUGIN_DIR) && (file_exists(WPPB_PLUGIN_DIR . '/update/update-checker.php')) ) {
            ...
            $wppb_bbp_update = new wppb_PluginUpdateChecker('http://updatemetadata.cozmoslabs.com/?localSerialNumber=' . $localSerial . '&uniqueproduct=CLPBBBP', __FILE__, 'wppb-bbp-add-on');
        }
        ...
        if ( ( in_array( 'bbpress/bbpress.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) || ( is_plugin_active_for_network('bbpress/bbpress.php') ) )  {
             ...
             */
            function wppb_bbp_add_plugin_stylesheet_front_end() {
            ...
            add_action('wp_enqueue_scripts' , 'wppb_bbp_add_plugin_stylesheet_front_end');
             ...
             */
            function wppb_bbp_get_template_directory(){
                return WPPB_BBP_PLUGIN_DIR . '/templates';
            }
            if ( function_exists('bbp_register_template_stack') )
                bbp_register_template_stack( 'wppb_bbp_get_template_directory', 10 );
             ...
             */
            function wppb_bbp_filter_template_parts($templates, $slug, $name){
            ...
            add_filter('bbp_get_template_part' , 'wppb_bbp_filter_template_parts', 10, 3);
             ...
             */
            add_filter('wppb_userlisting_get_merge_tags', 'wppb_bbp_add_bbpress_userlisting_tags', 10, 2);  //add tags to User Listing
            function wppb_bbp_add_bbpress_userlisting_tags( $tags, $type = '' ){
             ...
             */
            add_filter('wppb_email_customizer_get_merge_tags', 'wppb_bbp_add_bbpress_ec_tags'); //add tags to Email Customizer
            function wppb_bbp_add_bbpress_ec_tags ( $tags ){
            ...
            add_filter( 'mustache_variable_bbp_forum_role', 'wppb_bbp_handle_tag_bbp_forum_role', 10, 4 );
            function wppb_bbp_handle_tag_bbp_forum_role( $value, $name, $children, $extra_values){
            ...
            add_filter( 'mustache_variable_bbp_topics_started', 'wppb_bbp_handle_tag_bbp_topics_started', 10, 4 );
            function wppb_bbp_handle_tag_bbp_topics_started( $value, $name, $children, $extra_values){
            ...
            add_filter( 'mustache_variable_bbp_replies_created', 'wppb_bbp_handle_tag_bbp_replies_created', 10, 4 );
            function wppb_bbp_handle_tag_bbp_replies_created( $value, $name, $children, $extra_values){
            ...
            add_filter('mustache_variable_sort_tag', 'wppb_bbp_userlisting_sort_tags', 12, 4);
            function wppb_bbp_userlisting_sort_tags( $value, $name, $children, $extra_info ){
            ...
            function wppb_bbp_user_query_modifications( $query ){
            ...
            add_filter( 'pre_user_query', 'wppb_bbp_user_query_modifications', 11 );

            /*
             * Change query args for Userlisting sorting by Topics Started and Replies Created
             * */
            function wppb_bbp_change_user_query_args( $args ){
            ...
            add_filter('wppb_userlisting_user_query_args', 'wppb_bbp_change_user_query_args', 11);
             ...
             */
            function wppb_bbp_admin_notice() {
                ?>
                <div class="update-nag">
                    <?php _e( 'bbPress needs to be installed and activated for Profile Builder - bbPress Integration Add-on to work as expected!', 'profile-builder' ); ?>
                </div>
            <?php
            }
            add_action( 'admin_notices', 'wppb_bbp_admin_notice' );
        }
         ...
         *
         */
        function wppb_bbp_restrict_template_parts_forum( $templates, $slug, $name ) {
        ...
        if( function_exists( 'wppb_check_content_restriction_on_post_id' ) ) {
            add_filter('bbp_get_template_part', 'wppb_bbp_restrict_template_parts_forum', 10, 3);
        }
         ...
         *
         */
        function wppb_bbp_restrict_template_parts_topic( $templates, $slug, $name ) {
        ...
        if( function_exists( 'wppb_check_content_restriction_on_post_id' ) ) {
            add_filter('bbp_get_template_part', 'wppb_bbp_restrict_template_parts_topic', 10, 3);
        }
         ...
         *
         */
        function wppb_bbp_restrict_template_parts_reply( $templates, $slug, $name ) {
        ...
        if( function_exists( 'wppb_check_content_restriction_on_post_id' ) ) {
            add_filter('bbp_get_template_part', 'wppb_bbp_restrict_template_parts_reply', 10, 3);
        }

    }
}
add_action( 'plugins_loaded', 'wppb_bbp_plugin_init', 11 );
