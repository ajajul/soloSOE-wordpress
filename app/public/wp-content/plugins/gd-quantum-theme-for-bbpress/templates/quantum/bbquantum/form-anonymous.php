...
if ( bbp_current_user_can_access_anonymous_user_form() ) : ?>
    ...
    <fieldset class="bbp-form" id="bbp-anonymous">
        <legend><?php ( bbp_is_topic_edit() || bbp_is_reply_edit() ) ? esc_html_e( "Author Information", "gd-quantum-theme-for-bbpress" ) : esc_html_e( "Your information:", "gd-quantum-theme-for-bbpress" ); ?></legend>

		<?php do_action( 'bbp_theme_anonymous_form_extras_top' ); ?>

        <p>
            <label for="bbp_anonymous_author"><?php esc_html_e( "Name (required):", "gd-quantum-theme-for-bbpress" ); ?></label><br/>
        ...
        <p>
            <label for="bbp_anonymous_email"><?php esc_html_e( "Mail (will not be published) (required):", "gd-quantum-theme-for-bbpress" ); ?></label><br/>
            <input type="text" id="bbp_anonymous_email" value="<?php bbp_author_email(); ?>" size="40" maxlength="100" name="bbp_anonymous_email"/>
        </p>

        <p>
            <label for="bbp_anonymous_website"><?php esc_html_e( "Website:", "gd-quantum-theme-for-bbpress" ); ?></label><br/>
