...
<?php $stats = bbp_get_statistics(); ?>
    ...
    <div class="bbp-content-statistics">
        <dl role="main">
			<?php do_action( 'bbp_before_statistics' ); ?>

            <dt><?php _e( "Registered Users", "gd-quantum-theme-for-bbpress" ); ?></dt>
            <dd>
                <strong><?php echo esc_html( $stats['user_count'] ); ?></strong>
            </dd>

            <dt><?php _e( "Forums", "gd-quantum-theme-for-bbpress" ); ?></dt>
            <dd>
                <strong><?php echo esc_html( $stats['forum_count'] ); ?></strong>
            </dd>

            <dt><?php _e( "Topics", "gd-quantum-theme-for-bbpress" ); ?></dt>
            <dd>
                <strong><?php echo esc_html( $stats['topic_count'] ); ?></strong>
            </dd>

            <dt><?php _e( "Replies", "gd-quantum-theme-for-bbpress" ); ?></dt>
            <dd>
                <strong><?php echo esc_html( $stats['reply_count'] ); ?></strong>
            </dd>

            <dt><?php _e( "Topic Tags", "gd-quantum-theme-for-bbpress" ); ?></dt>
            <dd>
			...
			<?php if ( ! empty( $stats['empty_topic_tag_count'] ) ) : ?>
                ...
                <dt><?php _e( "Empty Topic Tags", "gd-quantum-theme-for-bbpress" ); ?></dt>
                <dd>
			...
			<?php if ( ! empty( $stats['topic_count_hidden'] ) ) : ?>
                ...
                <dt><?php _e( "Hidden Topics", "gd-quantum-theme-for-bbpress" ); ?></dt>
                <dd>
                    <strong>
			...
			<?php if ( ! empty( $stats['reply_count_hidden'] ) ) : ?>
                ...
                <dt><?php _e( "Hidden Replies", "gd-quantum-theme-for-bbpress" ); ?></dt>
                <dd>
                    <strong>
