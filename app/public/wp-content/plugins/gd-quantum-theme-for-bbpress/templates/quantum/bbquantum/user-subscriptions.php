...
<?php if ( bbp_is_subscriptions_active() ) : ?>
	...
	<?php if ( bbp_is_user_home() || current_user_can( 'edit_user', bbp_get_displayed_user_id() ) ) : ?>
        ...
        <div id="bbp-user-subscriptions" class="bbp-user-subscriptions">
            ...
            <h2 class="entry-title"><?php esc_html_e( "Subscribed Forums", "gd-quantum-theme-for-bbpress" ); ?></h2>
            <div class="bbp-user-section">
				...
				<?php else : ?>
                    ...
                    <p><?php bbp_is_user_home()
							? esc_html_e( "You are not currently subscribed to any forums.", "gd-quantum-theme-for-bbpress" )
							: esc_html_e( "This user is not currently subscribed to any forums.", "gd-quantum-theme-for-bbpress" );
						?></p>
            ...
            <h2 class="entry-title"><?php esc_html_e( "Subscribed Topics", "gd-quantum-theme-for-bbpress" ); ?></h2>
            <div class="bbp-user-section">
