...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div id="bbp-statistics" class="bbp-statistics">
        ...
        <div class="entry-content">
			...
			<?php get_the_content() ? the_content() : wpautop( esc_html__( "Here are the statistics and popular topics of our forums.", "gd-quantum-theme-for-bbpress" ) ); ?>
            ...
            <div id="bbpress-forums" class="bbpress-wrapper">
				...
				<?php if ( bbp_view_query( 'popular' ) ) : ?>
                    ...
                    <h2 class="entry-title"><?php esc_html_e( "Popular Topics", "gd-quantum-theme-for-bbpress" ); ?></h2>
