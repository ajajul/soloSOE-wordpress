    ...
    public function __construct() {
        ...
        if ($this->settings['notify_active']) {
            UserSettings::instance()->register(
                'thanks-notification',
                __("Thanks received", "gd-bbpress-toolbox"),
                __("Receive instant email notification when someone says thanks to you for topic or reply.", "gd-bbpress-toolbox"),
                'notifications',
                'checkbox',
                false
            );
...
Do not reply to this email!", "Email message: notify about post thanks", "gd-bbpress-toolbox");
            ...
            $start_subject = _x("[%BLOG_NAME%] Thanks received: %POST_TITLE%", "Email title: notify about post thanks", "gd-bbpress-toolbox");
            ...
            if ($user) {
                if (gdbbx_user($_author)->get('thanks-notification')) {
