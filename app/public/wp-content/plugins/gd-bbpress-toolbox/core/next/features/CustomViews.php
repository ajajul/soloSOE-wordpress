...
class CustomViews extends Feature {
    ...
    public $personal = array('newposts', 'myfuture', 'myattachments', 'myactive', 'mytopics', 'myreply', 'mynoreplies', 'mymostreplies', 'mymostthanked', 'myfavorite', 'mysubscribed');
    ...
    /** @return bool|\Dev4Press\Plugin\GDBBX\Features\CustomViews */
    ...
    public function register_views() {
        foreach ($this->views as $view => $data) {
            $args = array();
            $slug = $data['slug'];
            $title = __($data['title'], "gd-bbpress-toolbox");
            ...
            switch ($view) {
                ...
                case 'mymostreplies':
                case 'mostreplies':
                    $args = array('meta_key' => '_bbp_reply_count',
