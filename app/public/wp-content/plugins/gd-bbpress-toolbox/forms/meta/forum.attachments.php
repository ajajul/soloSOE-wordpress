...
<p>
    <label for="gdbbx_settings_attachments_preview_for_visitors"><?php _e("Show only files previews to visitors", "gd-bbpress-toolbox"); ?></label>
...
<h4><?php _e("Topic and Reply Forms", "gd-bbpress-toolbox"); ?>:</h4>
<p>
    <label for="gdbbx_settings_attachments_topic_form"><?php _e("Add to topic form", "gd-bbpress-toolbox"); ?></label>
...
<p>
    <label for="gdbbx_settings_attachments_reply_form"><?php _e("Add to reply form", "gd-bbpress-toolbox"); ?></label>
...
<p>
    <label for="gdbbx_settings_attachments_max_file_size_override"><?php _e("Status", "gd-bbpress-toolbox"); ?></label>
...
<p>
    <label for="gdbbx_settings_attachments_max_to_upload_override"><?php _e("Status", "gd-bbpress-toolbox"); ?></label>
...
<p>
    <label for="gdbbx_settings_attachments_mime_types_list_override"><?php _e("Status", "gd-bbpress-toolbox"); ?></label>
