<form role="search" method="get" id="bbp-search-form" action="<?php bbp_search_url(); ?>">
    <div>
        ...
        <label class="screen-reader-text hidden" for="<?php echo $this->form_unique_id($instance); ?>"><?php _e("Search for:", "gd-bbpress-toolbox"); ?></label>
            <input type="text" value="<?php echo esc_attr( bbp_get_search_terms() ); ?>" name="bbp_search" id="<?php echo $this->form_unique_id($instance); ?>" />
            <input class="button" type="submit" id="bbp_search_submit" value="<?php esc_attr_e("Search", "gd-bbpress-toolbox"); ?>" />
    </div>
</form>
