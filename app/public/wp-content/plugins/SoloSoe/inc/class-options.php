 ...
 class SOLOSOE_OPTIONS {
	...
	public function solosoe_create_admin_page() {
		...
		<div class="wrap">
			...
			<a href="https://solr.solosoe.com/solr/product_name_code_v2/select?defType=dismax&fl=*%2Cscore&mm=70%25&pf=name&ps=1&q=Peusek%20Arcandol%20spray&qf=name_code&wt=json" target="_blank">https://solr.solosoe.com/solr/product_name_code_v2/select?defType=dismax&fl=*%2Cscore&mm=70%25&pf=name&ps=1&q=Peusek%20Arcandol%20spray&qf=name_code&wt=json</a>
			<?php settings_errors(); ?>
